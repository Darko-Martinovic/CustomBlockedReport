...
BEGIN
	SET NOCOUNT ON;
     ...
     INSERT INTO @x
            SELECT session_id , blocking_session_id , ISNULL(exec_context_id , 0) AS exec_context_id , ISNULL(blocking_exec_context_id , 0) AS blocking_exec_context_id , ROW_NUMBER() OVER(ORDER BY session_id , blocking_session_id) AS level
...
--Add header who is blocked by whom 
             INSERT INTO @waitInfo ([BlockNo] , [VictemProgramName]
                    ...
                    SELECT @LEVEL , CAST(@blockedID AS NVARCHAR(4))+'('+CAST(@blockedECID AS NVARCHAR(4))+')=>'+CAST(@blockingID AS NVARCHAR(4))+'('+CAST(@blockingECID AS NVARCHAR(4))+')';
--Add detail information 
             INSERT INTO @waitInfo ( [BlockNo] , level , [DataBaseName] , [VictemProgramName] , [VictemHostName] , [VictemSessionId] , [VictemSessionEcid] , [VictemDruationSec] , [VictemWaitType] , [VictemDescription] , [VictemWaitResource] , [VictemStartTime] , [Command] , [CommandText] , [VictemStatus] , [VictemIsolationLevel] , [BLOCKED_BY] , [BlockingSessionId] , [BlockingEcid] , [BlockingProgramName] , [BlockingHostName] , [BlockingLastRequestStartTime] , [BlockingLastCommandText] , [BlockingStatus] , [BlockingIsolationLevel]
                    ...
                    SELECT @level , level , [DataBaseName] , [VictemProgramName] , [VictemHostName] , [VictemSessionId] , [VictemSessionEcid] , [VictemDruationSec] , [VictemWaitType] , [VictemDescription] , [VictemWaitResource] , [VictemStartTime] , [Command] , [CommandText] , [VictemStatus] , [VictemIsolationLevel] , [BLOCKED_BY] , [BlockingSessionId] , [BlockingEcid] , [BlockingProgramName] , [BlockingHostName] , [BlockingLastRequestStartTime] , [BlockingLastCommandText] , [BlockingStatus] , [BlockingIsolationLevel]
