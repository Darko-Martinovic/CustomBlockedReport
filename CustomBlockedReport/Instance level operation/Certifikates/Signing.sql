--
-- After changing GetLockInfo/GetWaitInfo/ProcessBlockedNotification add signature again
--
use AdventureWorks2014

CREATE CERTIFICATE [PBR]
ENCRYPTION BY PASSWORD = '$tr0ngp@$$w0rd'
WITH SUBJECT = 'Proces blocked report';
GO

-- Backup certificate so it can be create in master database
BACKUP CERTIFICATE [PBR]
TO FILE = 'C:\TMP\PBR.CER';
GO
...
CREATE CERTIFICATE [PBR]
FROM FILE = 'C:\TMP\PBR.CER';
GO
-- Create a login from the certificate
CREATE LOGIN [PBR]
FROM CERTIFICATE [PBR];
GO
